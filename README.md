...
```sh
grep -rl 'wow' ./ | xargs sed -i '' 's/wow/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with wow
...
Want to contribute? Ping us on `wow` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/wow.git
    cd wow
    ```
...
- [wow integration Documentation](https://docs.vuestorefront.io/wow)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `wow` channel on [our Discord](discord.vuestorefront.io).
