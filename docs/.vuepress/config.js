module.exports = {
  title: 'Vue Storefront 2 for wow',
  base: '/',
  description: 'Documentation for the wow connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/wow',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/wow'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/wow'}
    ],
    sidebar: [
      {
        title: 'Essentials',
